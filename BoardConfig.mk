...
# Assert
TARGET_OTA_ASSERT_DEVICE := X_Game,T1023
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 0x50339000
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0x1C03FF8000
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_PARTITION_SIZE := 0x22110000
...
TARGET_RECOVERY_INITRC := $(DEVICE_PATH)/recovery/root/init.recovery.mt6779.rc
...
#TW_DEFAULT_DEVICE_NAME := X_Game
TW_DEVICE_VERSION := X_Game_V1.0_20220112 by lopestom

# Resolution
DEVICE_RESOLUTION := 1280x1920
